...
<qgis version="2.18.10" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="lunghezza">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <customproperties>
    ...
    <property key="labeling/fontSize" value="0.8"/>
    ...
    <property key="labeling/yOffset" value="-0.5"/>
  ...
  <displayfield>lunghezza</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <aliases>
    <alias field="note" index="0" name=""/>
    <alias field="lunghezza" index="1" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="lunghezza"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="lunghezza" expression=""/>
