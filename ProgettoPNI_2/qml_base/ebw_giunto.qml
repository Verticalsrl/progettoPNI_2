...
<qgis version="2.18.10" simplifyAlgorithm="0" minimumScale="0" maximumScale="10000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="ebw_stato_">
  ...
  <customproperties>
    ...
    <property key="labeling/fontSize" value="1"/>
  ...
  <aliases>
    <alias field="ebw_stato_" index="0" name=""/>
    <alias field="note" index="1" name=""/>
    <alias field="nome" index="2" name=""/>
    <alias field="stato_cost" index="3" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      <column width="-1" hidden="0" type="field" name="ebw_stato_"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    <default field="ebw_stato_" expression=""/>
