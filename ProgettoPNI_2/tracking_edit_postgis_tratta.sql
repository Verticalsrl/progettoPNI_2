...
create trigger underground_route_prezzi_insert_update_trigger
  ...
  for each row
execute procedure public.underground_route_prezzi_insert_update('schemaDB', 'CITTA');
create trigger underground_route_prezzi_delete_trigger
  before delete
  on schemaDB.underground_route
  for each row
execute procedure public.underground_route_prezzi_delete('schemaDB', 'CITTA');
