...
<qgis version="2.18.10" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="dettaglio_">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="numero_cav">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="posa_area">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="altezza">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="lunghezza_">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="ente">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="numero_tub">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="larghezza">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="note">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="lunghezz_1">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="proprietar">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="tipo" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="Adduzione" label="Adduzione"/>
      <category render="true" symbol="1" value="Microtunnelling" label="Microtunnelling"/>
      <category render="true" symbol="2" value="Minitrincea" label="Minitrincea"/>
      <category render="true" symbol="3" value="Rete ED Aerea" label="Rete ED Aerea"/>
      <category render="true" symbol="4" value="Trincea" label="Trincea"/>
      <category render="true" symbol="5" value="Trincea Sterrato" label="Trincea Sterrato"/>
      <category render="true" symbol="6" value="Rete Altri Interrata" label="Rete Altri Interrata"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="4">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="241,0,0,255"/>
  ...
  <labeling type="rule-based">
    <rules key="{98b70310-854b-48b0-8f83-692729a2b189}">
      ...
      <rule description="Terzi" filter=" &quot;tipo&quot;   =  'Rete Altri Interrata' " key="{c5425e8f-a059-49b7-b7de-82252842180a}">
        <settings>
          <text-style fontItalic="0" fontFamily="MS Shell Dlg 2" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="7.8" fieldName="proprietar" namedStyle="Normal" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="numero_cav"/>
  ...
  <displayfield>categoria</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <aliases>
    <alias field="tipo" index="0" name=""/>
    <alias field="dettaglio_" index="1" name=""/>
    <alias field="numero_cav" index="2" name=""/>
    <alias field="posa_area" index="3" name=""/>
    <alias field="altezza" index="4" name=""/>
    <alias field="lunghezza_" index="5" name=""/>
    <alias field="ente" index="6" name=""/>
    <alias field="nome" index="7" name=""/>
    <alias field="stato_cost" index="8" name=""/>
    <alias field="categoria" index="9" name=""/>
    <alias field="numero_tub" index="10" name=""/>
    <alias field="larghezza" index="11" name=""/>
    <alias field="note" index="12" name=""/>
    <alias field="lunghezz_1" index="13" name=""/>
    <alias field="proprietar" index="14" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="dettaglio_"/>
      <column width="-1" hidden="0" type="field" name="numero_cav"/>
      <column width="-1" hidden="0" type="field" name="posa_area"/>
      <column width="-1" hidden="0" type="field" name="altezza"/>
      <column width="-1" hidden="0" type="field" name="lunghezza_"/>
      <column width="-1" hidden="0" type="field" name="ente"/>
      ...
      <column width="-1" hidden="0" type="field" name="numero_tub"/>
      <column width="-1" hidden="0" type="field" name="larghezza"/>
      <column width="-1" hidden="0" type="field" name="note"/>
      <column width="-1" hidden="0" type="field" name="lunghezz_1"/>
      <column width="-1" hidden="0" type="field" name="proprietar"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="dettaglio_" expression=""/>
    <default field="numero_cav" expression=""/>
    <default field="posa_area" expression=""/>
    <default field="altezza" expression=""/>
    <default field="lunghezza_" expression=""/>
    <default field="ente" expression=""/>
    <default field="nome" expression=""/>
    <default field="stato_cost" expression=""/>
    <default field="categoria" expression=""/>
    <default field="numero_tub" expression=""/>
    <default field="larghezza" expression=""/>
    <default field="note" expression=""/>
    <default field="lunghezz_1" expression=""/>
    <default field="proprietar" expression=""/>
  </defaults>
