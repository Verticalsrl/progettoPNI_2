...
COPY public.mappa_valori_pni2 (tabella, campo, valore, valore_tipo) FROM stdin;
...
colonnine	spec_id	PTA ALTRO	character varying(16)
colonnine	spec_id	PALO	character varying(16)
colonnine	spec_id	MTCO	character varying(16)
colonnine	spec_id	IP	character varying(16)
colonnine	spec_id	Box Esterno (MW)	character varying(16)
colonnine	spec_id	RF	character varying(16)
access_point	type	Unknown	character varying(16)
access_point	type	Conduit Terminus	character varying(16)
access_point	spec_id	Interno PFS	character varying(16)
pozzetti	type	Conduit Terminus	character varying(28)
pozzetti	type	Vault	character varying(28)
pozzetti	type	Residential Access	character varying(28)
...
ALTER TABLE ONLY public.mappa_valori_pni2
    ADD CONSTRAINT mappa_valori_pni2_pkey PRIMARY KEY (tabella, campo, valore);
